...
public class NFCCommunication extends Activity implements CreateNdefMessageCallback, OnNdefPushCompleteCallback {

	private static final int MESSAGE_SENT = 1;

	private static final String TAG = NFCCommunication.class.getName();
	...
	public void onNewIntent(Intent intent) {
	    ...
	    if (messages != null) { 
            ...
            Message composedMessage = composeMessage("Happy day.");
            NdefMessage composedMessageNdefMessage = composedMessage.getNdefMessage();
